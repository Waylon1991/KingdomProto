...
var file_Protocol_match_match_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0x4a, 0x0a, 0x05, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x12, 0x41, 0x0a, 0x05, 0x4d, 0x61,
	...
	0x63, 0x68, 0x2e, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x10, 0x5a,
	0x0e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x62,
...
var file_Protocol_match_match_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_Protocol_match_match_proto_goTypes = []interface{}{
	...
	(common.RoomMode)(0), // 2: protocol.common.RoomMode
}
var file_Protocol_match_match_proto_depIdxs = []int32{
	2, // 0: protocol.match.MatchRequest.mode:type_name -> protocol.common.RoomMode
	0, // 1: protocol.match.Match.Match:input_type -> protocol.match.MatchRequest
	1, // 2: protocol.match.Match.Match:output_type -> protocol.match.MatchReply
